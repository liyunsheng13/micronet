...
export OUTPUT_PATH=$2/micronet-m1-4gpu

CUDA_VISIBLE_DEVICES=0,1,2,3 python main.py --arch MicroNet -d $DATA_PATH --epochs 600 --lr-decay cos --lr 0.2 --wd 3e-5 \
                                                         -c $OUTPUT_PATH1 -j 48 --input-size 224 --label-smoothing 0.0 -b 512 \
